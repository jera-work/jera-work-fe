...
export class CandidateService {
    ...
    register(data: RegisterReqDto): Observable<InsertResDto> {
        return this.base.post<InsertResDto>(`${CANDIDATE_API}/candidates/register`, data, true);
    }

    updateProfile(data: CandidateProfileUpdateReqDto): Observable<UpdateResDto> {
        return this.base.put<UpdateResDto>(`${CANDIDATE_API}/candidates/profile`, data, true)
    }

    insertDocs(data: CandidateDocumentInsertReqDto[]): Observable<InsertResDto> {
        return this.base.post<InsertResDto>(`${CANDIDATE_API}/candidates/documents`, data, true)
    }

    insertEducations(data: CandidateEducationInsertReqDto[]): Observable<InsertResDto> {
        return this.base.post<InsertResDto>(`${CANDIDATE_API}/candidates/educations`, data, true)
    }

    insertExperiences(data: CandidateExperienceReqDto[]): Observable<InsertResDto> {
        return this.base.post<InsertResDto>(`${CANDIDATE_API}/candidates/experiences`, data, true)
    }

    insertSkill(data: CandidateSkillInsertReqDto[]): Observable<InsertResDto> {
        return this.base.post<InsertResDto>(`${CANDIDATE_API}/candidates/skills`, data ,true)
    }
